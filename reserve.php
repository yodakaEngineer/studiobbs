...
<main>
  ...
  <div class="calendarTitles">
    <button id="js-skipMonth" class="monthButton" type="button" name="button">前月</button>
    <h2 class="calendar-title"><span id="js-year"></span>年 <span id="js-month"></span>月</h2>
    <button id="js-returnMonth" class="monthButton" type="button" name="button">次月</button>
  </div>
